...
bool list_isEmpty(List* list);  // Devuelve true si la lista está vacía, false en caso contrario

/**
 * Obtiene el dato en la posición 'index' de la lista (empezando desde 0).
 * Retorna NULL si la posición es inválida.
 */
void* list_get(List* list, int index);

/**
 * Elimina el nodo en la posición 'index' de la lista.
 * Libera la memoria del nodo pero NO del dato (para que puedas transferirlo al inventario).
 * Retorna 0 si tuvo éxito, -1 si el índice es inválido.
 */
